...
core = ConfigPaths(
    default=resource_filename('Sequential_WC_Simulator', 'core/config/core.default.cfg'),
    schema=resource_filename('Sequential_WC_Simulator', 'core/config/core.schema.cfg'),
    user=(
...
debug_logs.default = resource_filename('Sequential_WC_Simulator', 'core/config/debug.default.cfg')
debug_logs.user = (
