...
class Specie(object):
    ...
    * `continuous_adjustment( population_change, time, flux )`
    ...
    __slots__ = ['specie_name', 'last_population', 'continuous_time', 'continuous_flux', 
        'stochastic_uniform_rounder', 'continuous_submodel']
    ...
    def __init__(self, specie_name, initial_population, initial_flux=None):
        ...
        self.stochastic_uniform_rounder = \
            StochasticRound(ReproducibleRandom.get_numpy_random()).stochastic_uniform_rounder
    ...
    def get_population(self, time=None):
        ...
        '''
        if not self.continuous_submodel:
            return self.stochastic_uniform_rounder(self.last_population)
        else:
            if time is None:
            ...
            return self.stochastic_uniform_rounder(float_copy_number)
