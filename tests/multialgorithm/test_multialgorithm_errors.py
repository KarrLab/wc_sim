...
class TestMultialgorithmErrors(unittest.TestCase):
    ...
    def test_negative_population_error(self):
        npe1 = NegativePopulationError('method_name', 'specie_name', 1, 2, 3)
        npe2 = NegativePopulationError('method_name', 'specie_name', 1, 2, 3)
        npe3 = NegativePopulationError('method_name_3', 'specie_name', 1, 2, 3)
